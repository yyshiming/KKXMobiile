...
public struct NavigationBarConfiguration {
    ...
    public static func theme() -> NavigationBarConfiguration {
    ...
    public static func background() -> NavigationBarConfiguration {
        var configuration = NavigationBarConfiguration()
    ...
    public static func clear() -> NavigationBarConfiguration {
        var configuration = NavigationBarConfiguration()
...
extension UIViewController {
    ...
    public var kkxStatusBarHeight: CGFloat {
        ...
        if #available(iOS 13.0, *) {
            statusBarFrame = UIApplication.shared.windows.first?.windowScene?.statusBarManager?.statusBarFrame ?? .zero
        } else {
    ...
    public var kkxTop: CGFloat {
        ...
        if #available(iOS 13.0, *) {
            isStatusBarHidden = UIApplication.shared.windows.first?.windowScene?.statusBarManager?.isStatusBarHidden ?? false
        } else {

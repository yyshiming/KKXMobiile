...
public class KKXFlowLayout: UICollectionViewFlowLayout {
    ...
    public struct DecorationConfiguration {
        ...
        public init(cornerRadius: CGFloat = 0.0, backgroundColor: UIColor = .clear, extendedLayoutIncludesHeader: Bool = false, extendedLayoutIncludesFooter: Bool = false) {
    ...
    private func createDecorationView(inSection section: Int) {
        ...
        attributes.cornerRadius = decorationConfiguration.cornerRadius
